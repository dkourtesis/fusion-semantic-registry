...
public class SemanticRegistryMatchmakingException extends Exception
{

	public SemanticRegistryMatchmakingException(String msg)
	{
		super(msg);	
	}

	public SemanticRegistryMatchmakingException()
	{
