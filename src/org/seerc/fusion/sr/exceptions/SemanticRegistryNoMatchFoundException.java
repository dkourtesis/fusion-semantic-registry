...
public class SemanticRegistryNoMatchFoundException extends Exception
{

	public SemanticRegistryNoMatchFoundException(String msg)
	{
		super(msg);	
	}

	public SemanticRegistryNoMatchFoundException()
	{
