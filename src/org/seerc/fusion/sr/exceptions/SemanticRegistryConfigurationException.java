...
public class SemanticRegistryConfigurationException extends Exception
{

	public SemanticRegistryConfigurationException(String msg)
	{
		super(msg);	
	}

	public SemanticRegistryConfigurationException()
	{
