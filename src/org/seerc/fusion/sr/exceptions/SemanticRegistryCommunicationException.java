...
public class SemanticRegistryCommunicationException extends Exception
{
	
	public SemanticRegistryCommunicationException(String msg)
	{
		super(msg);	
	}

	public SemanticRegistryCommunicationException()
	{
