...
//import org.seerc.fusion.sr.api.AdminManager;
//import org.seerc.fusion.sr.api.DiscoveryManager;
//import org.seerc.fusion.sr.api.xsd.DeployCanonicalTModelsRequest;
...
//import org.seerc.fusion.sr.api.xsd.ReclassifyAdvertisementsRequest;
//import org.seerc.fusion.sr.api.xsd.ReclassifyAdvertisementsResponse;


public class AdminManagerTester
{
	...
	public static void main(String[] args) 
	{
		...
		AdminManager mg = new AdminManager();
		...
		try
		{
			DeployCanonicalTModelsRequest request = new DeployCanonicalTModelsRequest();
			request.setUsername("juddi");
			request.setPassword("password");
			mg.removeAllAdvertisements(request);
		}
		catch (AxisFault e)
		{
...
//		try
//		{
//			ReclassifyAdvertisementsRequest request = new ReclassifyAdvertisementsRequest();
//			request.setProfileURI(requestedFunctionalProfileURI);
//			request.setUsername("juddi");
//			request.setPassword("password");
//			
//			ReclassifyAdvertisementsResponse res = mg.reclassifyAdvertisements(request);
//			String[] matchingServices = res.getReclassifyAdvertisementsResponse().getString();
//			
