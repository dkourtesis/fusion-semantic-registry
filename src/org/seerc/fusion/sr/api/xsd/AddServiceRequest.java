...
/**
 *  AddServiceRequest bean class
 */
public class AddServiceRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://api.sr.fusion.seerc.org/xsd",
            "addServiceRequest", "ns1");
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    AddServiceRequest.this.serialize(MY_QNAME, factory,
                        xmlWriter);
                }
            };
    ...
    public static class Factory {
         ...
         */
        public static AddServiceRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AddServiceRequest object = new AddServiceRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"addServiceRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AddServiceRequest) org.seerc.fusion.sr.api.xsd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
